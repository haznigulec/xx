...
import 'package:piapiri_v2/core/api/interceptor/polygon_header_interceptor.dart';
...
class PolygonApiClient {
  ...
  PolygonApiClient() {
    ...
    _client.interceptors.addAll(
      [
        PolygonHeaderInterceptor(),
        CustomLogInterceptor(
          talker: talker,
          addonId: 'PolygonClient',
  ...
  Dio _initDio() {
    final Dio dio = Dio(
      BaseOptions(
        baseUrl: AppConfig.instance.polygonUrl,
