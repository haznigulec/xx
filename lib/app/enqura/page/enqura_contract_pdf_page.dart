...
@RoutePage()
class EnquraContractPdfPage extends StatefulWidget {
  final String title;
  final String pdfUrl;
  const EnquraContractPdfPage({
    super.key,
    required this.title,
  ...
  @override
  State<EnquraContractPdfPage> createState() => _EnquraContractPdfPageState();
}

class _EnquraContractPdfPageState extends State<EnquraContractPdfPage> {
